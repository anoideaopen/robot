module github.com/atomyze-foundation/robot

go 1.18

require (
	github.com/atomyze-foundation/cartridge v0.0.0-20231101130905-94ef95cea82f
	github.com/atomyze-foundation/common-component v0.0.1
...
replace github.com/hyperledger/fabric-sdk-go => github.com/atomyze-foundation/fabric-sdk-go v0.0.1
